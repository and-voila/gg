              ...
              <div className="p-4">
                ...
                {menu.length ? (
                  <ul className="mt-16 flex w-full flex-col">
                    {menu.map((item) => (
                      <li
                        className="py-2 font-display text-3xl text-white transition-colors hover:text-white/70 dark:text-black dark:hover:text-black/70"
                        key={item.name}
                      >
                        <Link
                          href={item.href}
                    ...
                    <li className="py-4 font-display text-3xl text-white transition-colors hover:text-white/70 dark:text-black dark:hover:text-black/70">
                      <Link
