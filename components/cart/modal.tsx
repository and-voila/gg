                  ...
                  <ul className="flex-grow overflow-auto py-4">
                    {cart.lines.map((item, i) => {
                      ...
                      const merchandiseUrl = createUrl(
                        `/roasts/${item.merchandise.product.handle}`,
                      ...
                      return (
                        ...
                        >
                          <div className="relative flex w-full flex-row justify-between px-1 py-4">
                            ...
                            >
                              <div className="relative h-16 w-16 cursor-pointer overflow-hidden rounded-md border border-gray-300 bg-muted hover:bg-muted-foreground">
                                <Image
                            ...
                            <div className="flex h-16 flex-col justify-between">
                              ...
                              />
                              <div className="ml-auto flex h-9 flex-row items-center rounded-xl border border-border">
