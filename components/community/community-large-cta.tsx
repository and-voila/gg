...
const CommunityLargeCta: FC = () => {
  return (
    <div className="overflow-hidden px-6 py-24 sm:py-32 lg:px-8">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-2xl  bg-primary-foreground p-6 lg:flex lg:p-12 ">
